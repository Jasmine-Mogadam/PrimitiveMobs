...
@SideOnly(Side.CLIENT)
	public class RenderVoidEye<T extends EntityLiving> extends RenderLiving<EntityVoidEye>
	{
	    ...
	    public RenderVoidEye(RenderManager renderManagerIn)
	    {
	        super(renderManagerIn, new ModelVoidEye(true), 0.5f);
	        this.addLayer(new LayerVoidEyeSeen(this));
	    }
	    
	    public boolean shouldRender(EntityVoidEye livingEntity, ICamera camera, double camX, double camY, double camZ)
	    {
	     ...
	     */
	    public void doRender(EntityVoidEye entity, double x, double y, double z, float entityYaw, float partialTicks)
	    {
	        ...
	        if (entitylivingbase != null)
	        {
	            ...
	            {
		            this.bindTexture(VOIDEYE_BEAM_TEXTURE);
	            }
	            else
	            {
	            	this.bindTexture(VOIDEYE_BEAM_WEAK_TEXTURE);
	            }
